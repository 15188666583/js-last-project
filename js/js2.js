//        添加图书功能
        ...
        function build1() {
            ...
            var value9 = document.getElementById('value9'); //获取添加的ISBN
            var Oarr = [value4, value5, value6, value7, value8, value9];
            var Oclass = ['book', 'author', 'Onumber', 'press', 'price', 'isbn'];
        ...
        function search() {
            ...
            var value4 = document.getElementById('value0'); //获取输入的出版社名
            ...
            var isbn = document.getElementsByClassName('isbn'); //获取isbn名
            //                     alert(book.length);
            //遍历书库
            for (var i = 0; i < book.length; i++) {
                ...
                } else if (value4.value == isbn[i].innerHTML) {
                    isbn[i].style.color = 'red';
                    isbn[i].style.backgroundColor = 'white';
